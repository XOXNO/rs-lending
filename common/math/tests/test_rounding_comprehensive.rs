...
fn test_rescale_half_up_comprehensive() {
    ...
    assert_eq!(result1.as_raw_units(), &BigUint::from(1235u64)); // 1.235
    ...
    assert_eq!(result2.as_raw_units(), &BigUint::from(1234u64)); // 1.234
    ...
    assert_eq!(result3.as_raw_units(), &BigUint::from(1235u64)); // 1.235
    ...
    assert_eq!(result4.as_raw_units(), &BigUint::from(123000u64)); // 1.23000
    ...
    assert_eq!(result5.as_raw_units(), &BigUint::from(12345u64));
    ...
    assert_eq!(result6.as_raw_units(), &BigUint::from(13u64)); // 13
    ...
    assert_eq!(result7.as_raw_units(), &BigUint::from(0u64)); // 0.00
    ...
    assert_eq!(result8.as_raw_units(), &BigUint::from(1u64)); // 0.01
}
...
fn test_mul_half_up_comprehensive() {
    ...
    assert_eq!(result1.as_raw_units(), &BigUint::from(300u64)); // 3.00
    ...
    assert_eq!(result2.as_raw_units(), &BigUint::from(26u64)); // 2.6 (2.55 rounds up)
    ...
    assert_eq!(result3.as_raw_units(), &BigUint::from(689u64)); // 6.89
    ...
    assert_eq!(result4.as_raw_units(), &BigUint::from(5u64)); // 0.000005
    ...
    assert_eq!(result5.as_raw_units(), &BigUint::from(0u64));
    ...
    assert_eq!(result6.as_raw_units(), &BigUint::from(10890u64)); // 10.890
    ...
    assert_eq!(result7.as_raw_units(), &BigUint::from(63u64)); // 6.3 (6.25 rounds up)
}
...
fn test_div_half_up_comprehensive() {
    ...
    assert_eq!(result2.as_raw_units(), &BigUint::from(33u64)); // 0.33 (0.333... rounds down)
    ...
    assert_eq!(result3.as_raw_units(), &BigUint::from(25u64)); // 2.5
    ...
    assert_eq!(result4.as_raw_units(), &BigUint::from(1000u64)); // 0.001000
    ...
    assert_eq!(result5.as_raw_units(), &BigUint::from(1234u64)); // 1.234
    ...
    assert_eq!(result6.as_raw_units(), &BigUint::from(33333333u64)); // 333333.33
    ...
    assert_eq!(result7.as_raw_units(), &BigUint::from(667u64)); // 0.667
}
...
fn test_mul_half_up_signed_comprehensive() {
    ...
    assert_eq!(result1.as_raw_units(), &BigInt::from(30i64)); // 3.0
    ...
    assert_eq!(result2.as_raw_units(), &BigInt::from(-26i64)); // -2.6 (rounds away from zero)
    ...
    assert_eq!(result3.as_raw_units(), &BigInt::from(75i64)); // 7.5
    ...
    assert_eq!(result4.as_raw_units(), &BigInt::from(-63i64)); // -6.3 (rounds away from zero)
    ...
    assert_eq!(result5.as_raw_units(), &BigInt::from(0i64));
    ...
    assert_eq!(result6.as_raw_units(), &BigInt::from(-5i64)); // -0.000005
    ...
    assert_eq!(result7.as_raw_units(), &BigInt::from(-76i64)); // -7.6 (7.59 rounds away from zero)
}
...
fn test_div_half_up_signed_comprehensive() {
    ...
    assert_eq!(result1.as_raw_units(), &BigInt::from(25i64)); // 2.5
    ...
    assert_eq!(result2.as_raw_units(), &BigInt::from(-33i64)); // -0.33
    ...
    assert_eq!(result3.as_raw_units(), &BigInt::from(30i64)); // 3.0
    ...
    assert_eq!(result4.as_raw_units(), &BigInt::from(-17i64)); // -1.7 (rounds away from zero)
    ...
    assert_eq!(result5.as_raw_units(), &BigInt::from(-1234i64)); // -1.234
    ...
    assert_eq!(result6.as_raw_units(), &BigInt::from(-667i64)); // -0.667
    ...
    assert_eq!(result7.as_raw_units(), &BigInt::from(-5i64)); // -0.0005
}
